...
class Installation(models.Model):
    ...
    elecVAT = fields.Float(string="Electricity VAT %", required=True, help="the VAT of electricity as a %", default=6)
    elec_price_inflation = fields.Float(string="Electricity inflation %", required=True, default=3)
    auto_consumption_rate = fields.Float(string="Auto consumption rate %", required=True, help="the percentage of the electricity produced that is used on site")
    offer_validity = fields.Date(string="Offer validity", required=True, help="date after which the offer will be invalid")
